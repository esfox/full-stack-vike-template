...
export async function Page() {
  return (
    <div class="flex flex-col items-center justify-center h-screen" x-data="{ loading: false }">
      <a href="/auth/login" x-on:click="loading = !loading">
        <button
          class="btn btn-lg rounded-full"
          x-bind:class="loading ? 'btn-disabled' : ''"
